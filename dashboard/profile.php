    ...
    <div class="col-lg-8">
        <div class="card rounded-0 shadow">
            ...
            <div class="card card-body">
                <div class="row">
                    <div class="col-lg-4">
                        <label class="d-block" for="profile_img"><img class="profile_img img-fluid rounded-circle" src="https://api.dicebear.com/9.x/initials/svg?seed=<?= $fullName ?>" style="height: 258px;width:258px;object-fit:cover;object-position:center;" alt=""></label>
                        <input class="d-none" type="file" id="profile_img">
                    </div>
                    <div class="col-lg-8">
